...
function CheckOut() {
  document.title = `ITECHDEVICE - Pago y envío`;
    ...
    return (
      <section id="carrito" className="py-2 text-center container slide-in-fwd-center">
        <div className="row py-lg-2">
          <div><Badge bg="primary" className="m-1"><h6>Su ID de compra ${OrderID} Total de productos: {itemsTotal()}</h6></Badge><Badge className="m-3" bg="primary"><h6> Costo Total: {precioTotal()} $</h6></Badge><div></div><div><Link to="/">Regresar al catálogo</Link></div>
          </div>
        </div>
      </section>
    )
