...
const catPath = `/category/${detalle.category}`;
  ...
  document.title = `ITECHDEVICE  - ${detalle.category}/${detalle.name}`;
      ...
      <Breadcrumb.Item active>{detalle.name}</Breadcrumb.Item>
        ...
        <div className="row">
          <div className="col-sm-6 col-md-6 col-lg-6 push-bit align-middle">
            <span className="position-absolute top-10 end-90 translate-middle badge rounded-pill bg-primary">{isInCart && estaEnCarrito(detalle.id) ?
...
<div className="card-img-overlay h-100 d-flex flex-row justify-content-end">
    <div className="card-text border-0 bg-semitransparent text-center">
        <Badge className="bg-primary">Ir al carrito</Badge>
    </div>
</div>
</Link>
:
          ...
          <div className="col-sm-6 col-md-6 col-lg-6 push-bit text-center">
            <div className="clearfix py-3">
              <div className="pull-right">
                <h1><strong className="text-dark">{detalle.name}</strong><br /></h1>
                <h3><strong className="text-dark">{detalle.category}</strong><br /></h3>
                <span className="h2"><strong><Badge bg="dark">Precio {detalle.price}$</Badge></strong>
                {estaEnCarrito(detalle.id) ?
